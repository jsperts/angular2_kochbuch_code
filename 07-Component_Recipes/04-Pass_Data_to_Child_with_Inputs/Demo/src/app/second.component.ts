...
@Component({
  ...
  template: `
    ...
    <p>Damit "Change Object name Property" funktioniert muss der Button vor dem "Change Object Reference" geklickt werden.</p>
    <p>Wenn "Change Object Reference" als erstes geklickt wird, dann haben die Objekt im Parent und Child nicht mehr die gleiche Referenz und die Änderung von "Change Object name Property" wird im Parent nicht angezeigt.</p>
